...
public class Demo : MonoBehaviour
{
    ...
    */
    public void OnChooseMediaClick()
    {
        Debug.Log($"  yanqi - choose  media click");
        //ChooseMediaOption chooseMedia = new ChooseMediaOption
        //{
        //    camera="back" ,
        //    complete=OnchooseMediaGeneral_complete_CallbackResult ,
        //    fail=OnchooseMediaGeneral_fail_CallbackResult ,
        //    mediaType=new string[1] { "image" } ,
        ...
        ChooseImageOption chooseMedia = new ChooseImageOption
        {
            ...
            success=(result) =>
            {
                ...
                Debug.Log(" ChooseMediaSuccessCallback  : "+result.errMsg);
                // 获取图片地址
                var tempPath = result.tempFilePaths[0];
                txtUserInfo.text=tempPath;
                // 从图片地址取图片
